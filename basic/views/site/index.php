                ...
                <div class="row">
                    <div class="col-full">
                        <div class="wrap-col">
                            ...
                            <article>
                                <div class="heading"><h2 class="title"><a href="<?= Yii::$app->urlManager->createAbsoluteUrl(['site/view', 'id'=>$article->id]);?>"><?= $article->title; ?></a></h2></div>
                                <img src="<?= $article->getImage()?>"/>
                                <div class="content">
                                    <p><?= $article->description; ?></p>
                                </div>
                                <div class="extra">
                                    <div class="info">By Admin on <?= $article->getDate(); ?> - <a href="#">01 Commnets</a> <a href="<?=Yii::$app->urlManager->createAbsoluteUrl(['site/category', 'id'=>$article->category_id]);?>"><?= $article->category->title; ?></a> prosmotri <?= (int )$article->viewed; ?> </div>
                                    <div class="more"><a class="button" href="<?= Yii::$app->urlManager->createAbsoluteUrl(['site/view', 'id'=>$article->id]);?>"> Read more >></a></div>
                                    <div class="clear"></div>
                                </div>
                            </article>
                             <?php endforeach;?>
